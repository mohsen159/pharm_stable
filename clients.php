...
<body>
    ...
    <script>
        ...
        function single_client() {
            document.forms["single_client"]["id"].value = document.forms["edit_clients"]["id"].value;
            document.forms["single_client"]["name"].value = document.forms["edit_clients"]["name"].value;
            $('#edit').modal('hide');
            $('#single').modal('show');

        }

        function unsingle_client() {
            document.forms["unsingle_client"]["id"].value = document.forms["edit_clients"]["id"].value;
            document.forms["unsingle_client"]["name"].value = document.forms["edit_clients"]["name"].value;
            $('#edit').modal('hide');
            $('#unsingle').modal('show');
        ...
        function delet_client(id, name) {
            document.forms["delet_client"]["id"].value = document.forms["edit_clients"]["id"].value;
            document.forms["delet_client"]["name"].value = document.forms["edit_clients"]["name"].value;
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    if ($row['blocked']) {
                                        ...
                                        {
                                            echo "<td style='color:red' onclick=\"sale('" . $row['id'] . "','" . $row['name'] . "')\">" . $row['name']  . "</td>";
                                        }
                                      
                                    } else {
                                        echo "<td onclick=\"sale('" . $row['id'] . "','" . $row['name'] . "')\">" . $row['name']  . "</td>";
                                    }
                                    echo "<td>" . $row['next_sales'] . "</td>";
                                    echo "<td>" . ($row['note'] == null ? "NULL" : $row['note']) . "</td>";
                                    echo "<td class='operation'> 
 <button class='btn btn-info btn-sm edit btn-flat'  data-bs-toggle='modal' data-bs-target='#edit' onclick=\"foo1('" . $row['id'] . "','" . $row['name']  . "','" . $row['note'] . "','" . $row['blocked'] . "')\">More</button>
       </td>  ";
...
<script>
    function foo1(id_c, n, dot, singl) {
        if (singl != 1) {
        ...
        document.forms["edit_clients"]["id"].value = id_c;
        document.forms["edit_clients"]["name"].value = n;
        document.forms["edit_clients"]["note"].value = dot;
